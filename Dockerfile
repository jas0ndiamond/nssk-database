...
ADD ./database_setup/8_create_chloride_acuity_tables.sql /docker-entrypoint-initdb.d
ADD ./database_setup/9_create_cnv_hydrometric_tables.sql /docker-entrypoint-initdb.d
